...
connection = pymysql.connect(host='localhost',user='root',password='Pilot@181',db='uploaded_cv')
...
def run():
    ...
    link1 = '[©Developed by Shanvi](https://www.linkedin.com/in/shanvi-agarwal-93b38928b)'
    link2 = '[©Developed by Anshika](https://www.linkedin.com/in/anshika-agrawal-417305293)'
